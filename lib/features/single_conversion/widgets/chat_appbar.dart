...
import 'package:synqer_io/features/single_conversion/save_contact/save_contact_screen.dart';
...
Widget _buildMoreOptions(BuildContext context, String number, dynamic c) {
  return Builder(
            ...
            return Material(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Divider(height: 1, thickness: 0.6, color: c.dropdownDivider),
