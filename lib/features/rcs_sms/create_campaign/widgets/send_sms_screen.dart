      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.send_rounded, color: c.primary, size: 22),
              ),
          ...
          _SummarySection(
            ...
            rows: [
              _SummaryRow('Campaign Name', widget.campaignDetails.campaignName),
          ...
          _SummarySection(
            ...
            rows: [
              _SummaryRow('Template Name', template?.name ?? 'Not selected'),
              _SummaryRow('Template Type', template?.type ?? 'Not selected'),
            ...
            child: ValueListenableBuilder<bool>(
              ...
              builder: (context, isSending, _) {
                return ElevatedButton.icon(
                  onPressed: _canSend && !isSending ? _sendCampaign : null,
                  icon: isSending
                      ? SizedBox(
                          width: 18,
                          height: 18,
